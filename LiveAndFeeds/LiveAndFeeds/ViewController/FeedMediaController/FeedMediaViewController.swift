...
//        }
        ...
        self.title = "Live Channels";//clickedFeed.name
        self.activityIndicator.startAnimating()
       
        var meediAccess = MediaAccess()
        var mediaCount = meediAccess.getMediaCount("Live Channels");//meediAccess.getMediaCount(clickedFeed.name)
    ...
    var fetchedResultsController:NSFetchedResultsController {
        ...
        let livePredicate = NSPredicate(format: "feedName == %@", "Live Channels" )
...
//        }
    ...
    func DownloadMedia() {
        ...
        backgroundDownload.DownloadData("http://feed.theplatform.com/f/ZwuVLC/rolex?form=cjson", success: { (response: AnyObject!)->Void in
            //println("Success")
            
            var mediaArray = response["entries"]! as! NSMutableArray
            
            mediaAccess.insertIntoMedia(response, feedname: "Live Channels")
